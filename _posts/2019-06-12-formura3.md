---
layout: post
title: "格子計算プログラム生成言語Formuraを使ってみる その3"
...
[その2](https://kaityo256.github.io/formura2)では、一次元熱伝導方程式を解いてみた。今回はそれをそのまま二次元化しよう。

* [その1](https://kaityo256.github.io/formura1) インストールとコンパイルまで
* [その2](https://kaityo256.github.io/formura2) 一次元熱伝導方程式
* [その3](https://kaityo256.github.io/formura3) 二次元熱伝導方程式  ←イマココ
...
![image0.png](/assets/images/formura3/image0.png)
![image1.png](/assets/images/formura3/image1.png)
![image2.png](/assets/images/formura3/image2.png)

正しく計算できてるみたいですね。

せっかくなのでアニメGIFも置いておきましょうか。

![image3.gif](/assets/images/formura3/image3.gif)

## まとめ

一次元熱伝導方程式のファイルを修正して、Formuraに二次元熱伝導方程式を解かせてみた。ファイルを吐くところ以外、ほとんど修正の必要がなく、スムーズにできた。三次元への拡張も簡単であろう。

[その4](https://kaityo256.github.io/formura4)へ続く。
