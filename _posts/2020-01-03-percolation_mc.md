---
layout: post
title: "パーコレーションのモンテカルロシミュレーションコード"
tags: [programming, physics, qiita]
permalink: percolation_mc
---
...
<img width="776" alt="bond-percolation.png" src="https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/79744/432efad7-9d11-db73-8615-9fc463ee201c.png">
...
![image0.png](/assets/images/percolation_mc/image0.png)
...
![image1.png](/assets/images/percolation_mc/image1.png)

これも臨界点近傍で急激に立ち上がる関数になります。これらについて有限サイズスケーリングとかすると面白いのですが、そのあたりは適当に教科書読むかググってください。
