...
[前回](https://kaityo256.github.io/malloc1)は比較的振る舞いがシンプルな、mallocが内部でmmapを呼ぶケースについて調べたが、今回は`malloc_chunk`構造体と実際に使われるメモリ配置がちっとも対応していないことを見てみる。

* [mallocの動作を追いかける(mmap編)](https://kaityo256.github.io/malloc1)
* [mallocの動作を追いかける(prev_size編)](https://kaityo256.github.io/malloc2)  ← イマココ
...
[続く](https://kaityo256.github.io/malloc3)
