...
[Step3](https://kaityo256.github.io/sudoku_reg3)では、「一番上に来る行のヒントパターン」に着目し、それを四進法の数字だと思って枝刈りをした。これをもう少し考える。

今回のソースコードはここ。

[https://github.com/kaityo256/minlex/tree/master/step4](https://github.com/kaityo256/minlex/tree/master/step4)
...
[その5](https://kaityo256.github.io/sudoku_reg5)へ続く。
