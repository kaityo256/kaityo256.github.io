---
layout: post
title: "ARM SVEの組み込み関数を使う（その３）"
tags: [programming, qiita]
permalink: sve_intrinsic3
---
...
* [その３：gather/scatter](https://kaityo256.github.io/sve_intrinsic3) ← イマココ
...
コンパイルコマンドが長いので`ag++`という名前でaliasを張っています。詳細は「[その１](https://kaityo256.github.io/sve_intrinsic1)」を見てください。
...
![image0.png](/assets/images/sve_intrinsic3/image0.png)
...
![image1.png](/assets/images/sve_intrinsic3/image1.png)
...
この動作を確認するコードを書いてみます。「[その２](https://kaityo256.github.io/sve_intrinsic2)」で`svfloat64_t`の中身をダンプする関数を書きましたが、gatherにはインデックスをレジスタに入れる必要があるため、`svint64_t`の中身をダンプするコードも書いておきましょう。
...
![image2.png](/assets/images/sve_intrinsic3/image2.png)
...
[つづく](https://kaityo256.github.io/sve_intrinsic4)
