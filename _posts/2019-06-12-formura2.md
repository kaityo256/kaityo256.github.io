---
layout: post
title: "格子計算プログラム生成言語Formuraを使ってみる その2"
...
[その1](https://kaityo256.github.io/formura1)では、とりあえずFormuraのインストールと、Formuraが吐いたソースを読み込むmain関数を書いた。本稿では、簡単なシミュレーション例として一次元熱伝導方程式を解いてみる。前回と同じyamlとfmrを使い回すので、まだ読んでいない人は先に[その1](https://kaityo256.github.io/formura1)を参照してほしい。

* [その1](https://kaityo256.github.io/formura1) インストールとコンパイルまで
* [その2](https://kaityo256.github.io/formura2) 一次元熱伝導方程式  ←イマココ
* [その3](https://kaityo256.github.io/formura3) 二次元熱伝導方程式
* [その4](https://kaityo256.github.io/formura4) 反応拡散方程式(Gray-Scott系)
...
![image0.png](/assets/images/formura2/image0.png)
...
![image1.png](/assets/images/formura2/image1.png)
...
[その3](https://kaityo256.github.io/formura3)へ続く。
