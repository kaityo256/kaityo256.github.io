...
* [その１：Xbyakの概要](https://kaityo256.github.io/xbyak1)←イマココ
* [その２：数値計算屋のハマりどころ](https://kaityo256.github.io/xbyak2)
* [その３：AAarch64向けの環境構築](https://kaityo256.github.io/xbyak3)
* [その４：Xbyakからの関数呼び出し](https://kaityo256.github.io/xbyak4)
* [その５：Xbyakにおけるデバッグ](https://kaityo256.github.io/xbyak5)
...
![image0.png](/assets/images/xbyak1/image0.png)

getCodeのアセンブリが表示されました。ここで`n`で次に進みます。

![image1.png](/assets/images/xbyak1/image1.png)

現在の行が`>`で表示されていますが、次の`call q *%rax`がXbyakが作った関数呼び出しです。`si`二回で進んでみましょう。

![image2.png](/assets/images/xbyak1/image2.png)
...
![image3.png](/assets/images/xbyak1/image3.png)
...
[続く](https://kaityo256.github.io/xbyak2)
