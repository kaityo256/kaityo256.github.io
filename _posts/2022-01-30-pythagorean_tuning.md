...
[Pythonで音を鳴らす](https://kaityo256.github.io/python_play_sound)という記事で、平均律とピタゴラス音律について触れました。音律とは、いわゆる「ドレミファソラシド」を、どのような周波数比とするかの決まりです。
...
![ピタゴラス音律](/assets/images/pythagorean_tuning/pythagorean.png)
...
![純正率](/assets/images/pythagorean_tuning/just.png)
...
![平均率](/assets/images/pythagorean_tuning/equal.png)
