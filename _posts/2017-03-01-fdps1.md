...
MacでMPI環境を作るのはわりと面倒。特にFDPSはなぜかMPIのC++バインディングを使っているので注意。環境構築については[MacにMPI+OpenMPハイブリッド並列環境を構築する](https://kaityo256.github.io/mac_mpi_openmp)に書いたのでそちらを参照。この方法でFDPSが使えるようになるはず。
...
[その2](https://kaityo256.github.io/fdps2)へ続く。
