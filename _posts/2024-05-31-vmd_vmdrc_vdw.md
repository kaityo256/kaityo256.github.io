...
![lines](/assets/images/vmd_vmdrc_vdw/lines.png)

メニューのGraphics→Representationsで設定画面を開き、Drawing MethodをLinesからVDWにすると、つぶつぶとして可視化できる。

![lines](/assets/images/vmd_vmdrc_vdw/menu.png)

![vdw](/assets/images/vmd_vmdrc_vdw/vdw.png)
...
![vdw](/assets/images/vmd_vmdrc_vdw/vmd_cmdline.png)
...
![vdw](/assets/images/vmd_vmdrc_vdw/vmd_win.png)
...
![vdw](/assets/images/vmd_vmdrc_vdw/vmd_shortcut.png)
