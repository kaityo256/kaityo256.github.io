...
![weird_errorbars/exp1.png](/assets/images/weird_errorbars/exp1.png)
...
![weird_errorbars/exp2.png](/assets/images/weird_errorbars/exp2.png)

### ケース2

もし、観測値のそれぞれに独立なノイズが乗っているのであれば、エラーバーは、観測回数を増やせば減っていくはずです。観測回数$n$に対して、物理量の推定値とエラーバーがどうなるかを表したグラフでこんなものがあったとします。

![weird_errorbars/corr1.png](/assets/images/weird_errorbars/corr1.png)

試行回数$n$を増やすにつれて、平均値は$0.5$に収束し、さらにエラーバーも小さくなっています。一見それっぽく見えますが、僕はこのグラフを見たら「ん？」と思います。

一方、こちらも同様なグラフです。

![weird_errorbars/corr2.png](/assets/images/weird_errorbars/corr2.png)
...
![weird_errorbars/exp1_line.png](/assets/images/weird_errorbars/exp1_line.png)
...
![weird_errorbars/exp2_line.png](/assets/images/weird_errorbars/exp2_line.png)
...
![weird_errorbars/corr1.png](/assets/images/weird_errorbars/corr1_line.png)
...
![weird_errorbars/corr2_line.png](/assets/images/weird_errorbars/corr2_line.png)
...
![ave](/assets/images/weird_errorbars/langevin_circle.jpg)
...
![ave2](/assets/images/weird_errorbars/langevin2_line.png)
